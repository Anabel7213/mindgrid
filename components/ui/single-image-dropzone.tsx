...
const variants = {
  base: "relative rounded-md flex justify-center items-center flex-col cursor-pointer min-h-[150px] border border-dashed border-gray-400 min-w-[200px] dark:border-gray-300 transition-colors duration-200 ease-in-out",
  image:
